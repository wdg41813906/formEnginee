...
//     this.props.onChange({ value: checkedValues });
//   }
...
//           this.props.panes ?
//             <div>
//               <RadioGroup disabled={this.props.disabled} onChange={this.OptionChange} value={this.props.value} style={{display: 'block'}}>
//                 {
...
//             :
//             <div>
//               <CheckboxGroup disabled={this.props.disabled} onChange={this.OptionsChange} value={this.props.value}>
//                 {
