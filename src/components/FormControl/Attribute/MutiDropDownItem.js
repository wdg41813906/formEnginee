  ...
  render() {
    ...
    let radios = this.props.dropdownList.map((p, index) => {
      return <div key={index} style={{ marginTop: 5 }}>
        ...
        <Input style={{ width: 220 }} data-index={index.toString()} value={p} defaultValue={p} onChange={this.changeInput.bind(this)} />
    ...
    return (
      <div>
        <CheckboxGroup disabled={this.props.disabled} onChange={this.changeOption.bind(this)} value={this.props.value}>
          {radios}
        </CheckboxGroup>
