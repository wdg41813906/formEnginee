		...
		switch (type) {
			case 'group':
				return (<Modal {...modalOpts}>
					{
						<Input placeholder="请输入职责组名称" onChange={this.onTextChange} />
					}
				</Modal>)
			case 'role':
				return (<Modal {...modalOpts}>
					{
						...
						<div>
							<div style={{ display: "flex" }}>
								<p style={{ width: "25%" }}>职责名称: </p>
								<Input placeholder="请输入职责名称" onChange={this.onTextChange} />
							</div>
