    ...
    return (
      <div>
        <Row>
          <Col span={6}>
            <div >
              <Button type="primary" className={styles['addGroupbtn']} ghost={true} onClick={this.props.OnAddShow}>新增职责组</Button>
              <Button type="primary" className={styles['addbtn']} ghost={true} onClick={this.props.OnShow}>新增职责</Button>
            </div>
