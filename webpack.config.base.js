...
module.exports = {
    ...
    externals: {
        _config: "config",
        MobileFormEnginePlugin: "MobileFormEnginePlugin",
    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            PRINT_URL: JSON.stringify(
                process.env.NODE_ENV === "development" ? "http://171.221.227.116:39011/gpp/reports/launch.js" : ""
            )
        })
    ],
    resolve: {
        alias: {
            ...
            commonForm$: path.resolve(__dirname, "src/models/common/Form.js")
        }
    }
};
